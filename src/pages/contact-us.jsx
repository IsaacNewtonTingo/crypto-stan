        ...
        <div className="pt-10 pb-10 flex flex-col lg:flex-row gap-6 lg:gap-20">
          <div className="w-full lg:w-1/2">
            ...
            <p>
              ...
              First Co Limited is here to help. Reach out to us through any of
          ...
          <form
            onSubmit={submit}
            className="bg-gradient-to-r from-gray-900 to-primary-900 p-6 lg:p-10 rounded-lg w-full lg:w-1/2 mt-10 lg:mt-0"
          >
            <PrimaryInput
