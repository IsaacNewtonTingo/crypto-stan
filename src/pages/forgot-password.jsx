...
export default function ForgotPassword() {
  ...
  async function submit(e) {
    try {
      ...
      if (!email) {
        ...
        const url = `${process.env.REACT_APP_API_ENDPOINT}/api/user/auth/forgot-password`;
        const headers = {
  ...
  async function verify(e) {
    ...
    try {
      if (!email) {
        ...
        const url = `${process.env.REACT_APP_API_ENDPOINT}/api/user/auth/reset-password`;
        const headers = {
          "auth-token": process.env.TOKEN,
        };
  ...
  return (
    <div className="flex">
      {/* <Head>
        <title>Reset Password - Custom Jerseys Kenya</title>
        <meta
          name="description"
          content="Forgot your Custom Jerseys Kenya account password? Enter your email address associated with your account to help reset your password."
        />

        <meta property="og:title" content="Reset Password - Custom Jerseys" />
        <meta
        ...
        <meta
          property="og:url"
          content="https://customjerseys.co.ke/forgot-password"
        />
      ...
      <div className="w-full md:w-[30%] bg-gray-50 min-h-screen p-10">
        ...
        <Title className="text-[30px] mt-10 text-gray-700">
          RESET YOUR PASSWORD
        </Title>
        ...
        <form onSubmit={submit} className="mt-10">
          ...
          <p className="text-gray-500 text-sm mb-4 mt-2">
            Enter the email address you used to register. A one time password
            will be sent to help recover your account
          </p>
          <TextInput
      ...
      <div className="hidden w-[70%] bg-gray-100 p-10 md:flex items-center">
        <svg
        ...
        >
          ...
          <path
            ...
            fill="#6c63ff"
          />
          <circle cx="620.40945" cy="322.7141" r="7" fill="#6c63ff" />
          <path
          ...
          <path
            ...
            fill="#6c63ff"
          />
          <circle cx="619.09426" cy="306.41937" r="7" fill="#6c63ff" />
          <path
          ...
          <rect x="195" y="363.23676" width="49" height="180" fill="#6c63ff" />
          <rect
            x="302"
            y="236.23675"
            width="49"
          ...
          <path
            ...
            fill="#6c63ff"
          />
          <circle cx="723.40945" cy="300.7141" r="7" fill="#6c63ff" />
          <path
