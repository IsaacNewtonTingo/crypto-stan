    ...
    <div className="fixed left-0 right-0 z-50 flex items-center justify-center w-full bg-[rgba(0,0,0,0.9)] md:inset-0 h-screen">
      <div className="w-[90%] md:w-[40%] bg-gray-50 rounded-lg p-6 gap-4">
        <div className="flex items-center justify-between">
          <Title className="text-[30px] text-primary-900">
        ...
        <p className="text-gray-500 mt-4">
          Please enter the details below. Your line manager will reach out to
          you shortly
        </p>

        <form onSubmit={contactManager}>
          <Label myStyles="mt-8">Deposit amount (USD)*</Label>
          <TextInput
