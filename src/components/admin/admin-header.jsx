        ...
        open ? (
          ...
          <div className="w-[75%] flex items-center justify-end gap-2">
            ...
            <img
              ...
              className="hidden lg:block w-[40px] h-[40px] rounded-[40px] border-2 border-myBlack cursor-pointer"
            />
